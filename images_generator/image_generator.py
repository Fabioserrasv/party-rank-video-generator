...
def generate_images():
    ...
    for song in series["series"]:
        ...
        text.text((1661+random_number2,70+25+190+190+random_number),series["series"][song]["notes"][1], fill=colors_note[1], font=font242, anchor='mm')
        ...
        text.text((1661+random_number2,70+25+190+190+190+random_number),series["series"][song]["notes"][2], fill=colors_note[2], font=font242, anchor='mm')
        ...
        text.text((1661+random_number2,70+25+190+190+190+190+random_number),series["series"][song]["notes"][3], fill=colors_note[3], font=font242, anchor='mm')
        ...
        text.text((1503+random_number2,70+25+190+random_number),series["series"][song]["notes"][4], fill=colors_note[4], font=font242, anchor='mm')
        ...
        text.text((1503+random_number2,70+25+190+190+random_number),series["series"][song]["notes"][5], fill=colors_note[5], font=font242, anchor='mm')
        ...
        text.text((1503+random_number2,70+25+190+190+190+random_number),series["series"][song]["notes"][6], fill=colors_note[6], font=font242, anchor='mm')
        ...
        text.text((1503+random_number2,70+25+190+190+190+190+random_number),series["series"][song]["notes"][7], fill=colors_note[7], font=font242, anchor='mm')
